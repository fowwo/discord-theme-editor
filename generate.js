...
addSection("Mentioned", "background-mentioned", "The color of the background behind messages that mention you.");
...
addSection("info-warning-foreground", "info-warning-foreground", "");
